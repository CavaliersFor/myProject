...
public class Seller implements Serializable {
	private static final long serialVersionUID = 14774015887352L;
	...
	*
	...
	public String toString() {
		return "Seller [ id=" + id + ", gmtCreate=" + gmtCreate + ", gmtModify=" + gmtModify + ", status=" + status + ", registerName=" + registerName + ", mobile=" + mobile + ", loginCount=" + loginCount + ", loginErrorCount=" + loginErrorCount + ", lastLoginTime=" + lastLoginTime + ", lastFreezeTime=" + lastFreezeTime + ", lastLockTime=" + lastLockTime + ", destroyTime=" + destroyTime + ", userType=" + userType + ", checkStatus=" + checkStatus + ", passWord=" + passWord + ", email=" + email + "]";
	}
}
