...
public class Express implements Serializable {
	private static final long serialVersionUID = 14782655820032L;
	...
	*
	...
	public String toString() {
		return "Express [ id=" + id + ", enterpriseId=" + enterpriseId + ", ecPrice=" + ecPrice + ", gmtCreate=" + gmtCreate + ", gmtModify=" + gmtModify + ", ecStatus=" + ecStatus + ", valuation=" + valuation + "]";
	}
}
