...
public class Enterprise implements Serializable {
	private static final long serialVersionUID = 14793807079452L;
	...
	*
	...
	public String toString() {
		return "Enterprise [ id=" + id + ", gmtCreate=" + gmtCreate + ", gmtModify=" + gmtModify + ", account=" + account + ", password=" + password + ", enterpiseName=" + enterpiseName + ", contactPhone=" + contactPhone + ", orgNo=" + orgNo + ", businessNo=" + businessNo + ", taxNo=" + taxNo + ", legalName=" + legalName + ", email=" + email + ", fax=" + fax + ", province=" + province + ", city=" + city + ", region=" + region + ", address=" + address + ", postCode=" + postCode + ", enterpriseType=" + enterpriseType + ", bussinessScope=" + bussinessScope + ", trade=" + trade + ", businessLicenceUrl=" + businessLicenceUrl + ", telephone=" + telephone + ", enterpiseAlias=" + enterpiseAlias + ", linkMan=" + linkMan + ", distributionMode=" + distributionMode + ", deliveryDeadline=" + deliveryDeadline + ", headPicUrl=" + headPicUrl + "]";
	}
}
