...
public class SelfDeliveryUser implements Serializable {
	private static final long serialVersionUID = 14801076020832L;
	...
	*
	...
	public String toString() {
		return "SelfDeliveryUser [ id=" + id + ", userName=" + userName + ", passWord=" + passWord + ", gmtCreate=" + gmtCreate + ", gmtModify=" + gmtModify + ", status=" + status + ", collectPlaceId=" + collectPlaceId + "]";
	}
}
