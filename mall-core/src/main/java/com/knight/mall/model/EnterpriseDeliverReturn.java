...
public class EnterpriseDeliverReturn implements Serializable {
	private static final long serialVersionUID = 14784956813292L;
	...
	*
	...
	public String toString() {
		return "EnterpriseDeliverReturn [ id=" + id + ", enterpriseId=" + enterpriseId + ", gmtCreate=" + gmtCreate + ", gmtModify=" + gmtModify + ", status=" + status + ", address=" + address + ", province=" + province + ", city=" + city + ", region=" + region + ", type=" + type + ", isDefault=" + isDefault + ", linkname=" + linkname + ", telephone=" + telephone + "]";
	}
}
