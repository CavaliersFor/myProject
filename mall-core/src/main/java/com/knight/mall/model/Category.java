...
public class Category implements Serializable {
	private static final long serialVersionUID = 14773460716342L;
	...
	*
	...
	public void setParentId(Long parentId) {
		...
		/**图片url地址以及排序url地址与排序值和产品id,图片跳转地址之间用,号隔开，然后每个之间用;隔开*/
	...
	public String toString() {
		return "Category [ id=" + id + ", gmtCreate=" + gmtCreate + ", gmtModify=" + gmtModify + ", status=" + status + ", name=" + name + ", shopId=" + shopId + ", sortNum=" + sortNum + ", parentId=" + parentId + ", slidesUrls=" + slidesUrls + "]";
	}
}
