...
public class LogisticsCompany implements Serializable {
	private static final long serialVersionUID = 14772966006852L;
	...
	*
	...
	public String toString() {
		return "LogisticsCompany [ id=" + id + ", code=" + code + ", name=" + name + ", status=" + status + ", gmtCreate=" + gmtCreate + ", gmtModify=" + gmtModify + "]";
	}
}
