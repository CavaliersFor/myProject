...
public class ProductShop implements Serializable {
	private static final long serialVersionUID = 14761551108242L;
	...
	*
	...
	public String toString() {
		return "ProductShop [ id=" + id + ", productId=" + productId + ", shopId=" + shopId + ", categoryId=" + categoryId + ", gmtCreate=" + gmtCreate + ", gmtModify=" + gmtModify + ", status=" + status + ", type=" + type + "]";
	}
}
