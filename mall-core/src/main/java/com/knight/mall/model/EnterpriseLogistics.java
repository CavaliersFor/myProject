...
public class EnterpriseLogistics implements Serializable {
	private static final long serialVersionUID = 14802994253392L;
	...
	*
	...
	public String toString() {
		return "EnterpriseLogistics [ id=" + id + ", enterpriseId=" + enterpriseId + ", logisticsId=" + logisticsId + ", logisticsCode=" + logisticsCode + ", logisticsName=" + logisticsName + ", status=" + status + ", gmtCreate=" + gmtCreate + ", gmtModify=" + gmtModify + "]";
	}
}
