...
public class BuyerAddress implements Serializable {
	private static final long serialVersionUID = 14777620230762L;
	...
	*
	...
	public String toString() {
		return "BuyerAddress [ id=" + id + ", gmtCreate=" + gmtCreate + ", gmtModify=" + gmtModify + ", buyerId=" + buyerId + ", province=" + province + ", city=" + city + ", region=" + region + ", status=" + status + ", buyerName=" + buyerName + ", buyerPhone=" + buyerPhone + ", buyerAddress=" + buyerAddress + ", buyerPostCode=" + buyerPostCode + ", isDefault=" + isDefault + "]";
	}
}
