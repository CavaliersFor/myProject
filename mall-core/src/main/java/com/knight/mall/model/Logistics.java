...
public class Logistics implements Serializable {
	private static final long serialVersionUID = 14768673045942L;
	...
	*
	...
	public String toString() {
		return "Logistics [ id=" + id + ", tradeId=" + tradeId + ", logisticsName=" + logisticsName + ", logisticsNo=" + logisticsNo + ", status=" + status + ", sendTime=" + sendTime + ", station=" + station + ", arriveTime=" + arriveTime + ", gmtCreate=" + gmtCreate + ", gmtModify=" + gmtModify + ", logisticsPhone=" + logisticsPhone + "]";
	}
}
